...
local Window = OrionLib:MakeWindow({Name = "ITACHI X HUB - V1.0", HidePremium = false, IntroText = "ITACHI Library", SaveConfig = true, ConfigFolder = "ITACHI X HUB"})
----------Tab-----------------------
local W = Window:MakeTab({
    Name = "Tab Update",
    Icon = "rbxassetid://16854126816",
    PremiumOnly = false
})
